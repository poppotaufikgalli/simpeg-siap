<div>
    <div class="card-body">
        <form wire:submit.prevent={{$next}} method="POST">
            ...
            <div class="mb-3 row">
                <label for="_id" class="col-sm-2 col-form-label">ID Kompetensi</label>
                <div class="col-sm-6">
            ...
            <div class="mb-3 row">
                ...
                <label for="nama_id" class="col-sm-2 col-form-label">Singkatan</label>
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="nama_id" wire:model.debounce.500ms="dataset.nama_id" required>
                </div>
            </div>
            <div class="mb-3 row">
                <div class="col-sm-10 offset-sm-2">
