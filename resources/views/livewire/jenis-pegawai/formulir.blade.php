<div>
    <div class="card-body">
        <form wire:submit.prevent={{$next}} method="POST">
            ...
            <div class="mb-3 row">
                <label for="_id" class="col-sm-2 col-form-label">Kode Jenis Pegawai</label>
                <div class="col-sm-3">
                    <input type="number" class="form-control" id="id" wire:model="dataset._id" {{$sid != "" ? 'disabled' : 'required'}}>
                </div>
                <label for="ref_simpeg" class="col-sm-2 col-form-label">Referensi SIMPEG</label>
                <div class="col-sm-3">
                    <input type="number" class="form-control" id="ref_simpeg" wire:model="dataset.ref_simpeg">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="nama" class="col-sm-2 col-form-label">Nama Jenis Pegawai</label>
                <div class="col-sm-10">
