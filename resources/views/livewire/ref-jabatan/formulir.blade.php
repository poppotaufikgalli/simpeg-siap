<div>
    <div class="card-body">
        <form wire:submit.prevent={{$next}} method="POST">
            ...
            <div class="mb-3 row">
                <label for="bup_usia" class="col-sm-2 col-form-label">BUP Usia</label>
                <div class="col-sm-2">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="cepat_kode" wire:model.debounce.500ms="dataset.cepat_kode">
                </div>
