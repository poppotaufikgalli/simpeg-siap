...
class RiwPangkat extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.pegawai.riwayat-pegawai.riw-pangkat', [
    ...
    public function update(){
        ...
        $validator = Validator::make($data, [
            ...
            'kgolru' => [
                ...
                })->ignore($this->sid, 'nip', $this->kgolru, 'kgolru', $this->tmtpang, 'tmtpang')],
        ],[
        ...
        if($this->kgolru == $data['kgolru'] && $this->tmtpang == $data['tmtpang']){
            ...
            $this->dispatchBrowserEvent('informations', "Data Riwayat Pangkat Terakhir berhasil diubah");    
    ...
    public function store(){
        ...
        $this->dispatchBrowserEvent('informations', "Data Riwyat Pangkat Terakhir berhasil ditambahkan");  
